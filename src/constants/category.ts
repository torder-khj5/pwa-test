...
export const SAMPLE_CATEGORY: { data: CategoryType[] } = {
  data: [
      ...
      subCategory: [
        {
          ...
          id: 'salad',
          name: '샐러드',
          languageName: { ko: '샐러드', en: 'Salad', jp: 'サラダ', zh_hans: '沙拉', zh_hant: '沙律' },
          code: '110721',
          productList: [
            {
              name: '시저 샐러드',
            ...
            },
            {
              ...
              html: '바삭하게 구운 햄 및 브레드, 신선한 로메인 상추가 홈메이드 시저 드레싱과 어우러진 건강식 샐러드입니다. 샐러드 위에 얇게 썰은 이탈리안 고급 치즈가 토핑되어 고소한 맛을 더합니다.  \n추가로 그릴 새우, 연어, 닭가슴살 중 선택해 드실 수 있습니다.',
              image:
                'https://hyatt.static.torder.co.kr/INFRA_CAFE8002/goods/CJUGH-240053038/1676349675item_700X700.png',
              price: 36000,
          ...
          productList: [
            {
              ...
              image:
                'https://hyatt.static.torder.co.kr/INFRA_CAFE8002/goods/CJUGH-240051007/1676349839item_700X700.png',
              price: 14000,
              countryOfOrigin: '',
            ...
            },
            {
              ...
              image:
                'https://hyatt.static.torder.co.kr/INFRA_CAFE8002/goods/CJUGH-240051010/1676349842item_700X700.png',
              price: 16000,
              countryOfOrigin: '(베이컨:미국산)',
          ...
          productList: [
            {
              ...
              image:
                'https://hyatt.static.torder.co.kr/INFRA_CAFE8002/goods/CJUGH-240042005/1676349948item_700X700.png',
              price: 23000,
            ...
            },
            {
              ...
              image:
                'https://hyatt.static.torder.co.kr/INFRA_CAFE8002/goods/CJUGH-240041001/1676349950item_700X700.png',
              price: 28000,
          ...
          productList: [
            {
              ...
              image:
                'https://hyatt.static.torder.co.kr/INFRA_CAFE8002/goods/CJUGH-240071017/1676349875item_700X700.png',
              price: 22000,
              countryOfOrigin: '',
            },
            {
          ...
          productList: [
            {
              ...
              html: '',
              image:
                'https://hyatt.static.torder.co.kr/INFRA_CAFE8002/goods/CJUGH-000155001/1676354498item_700X700.png',
              price: 5500,
              countryOfOrigin: '',
            },
            {
              ...
              html: '',
              image:
                'https://hyatt.static.torder.co.kr/INFRA_CAFE8002/goods/CJUGH-000155002/1676354501item_700X700.png',
              price: 5500,
              countryOfOrigin: '',
            },
          ],
          ...
          productList: [
            {
              ...
              image:
                'https://hyatt.static.torder.co.kr/INFRA_CAFE8002/goods/CJUGH-240152007/1676354577item_700X700.png',
              price: 1300,
              countryOfOrigin: '',
            },
            {
              ...
              image:
                'https://hyatt.static.torder.co.kr/INFRA_CAFE8002/goods/CJUGH-240152004/1676354572item_700X700.png',
              price: 13000,
              countryOfOrigin: '',
            },
          ],
    ...
    },
    {
      id: 'dessert',
      name: '디저트',
      languageName: { ko: '디저트', en: 'Dessert', jp: 'デザート', zh_hans: '甜品', zh_hant: '甜品' },
      code: '110731',
      subCategory: [
        {
          categoryCode: '110731',
