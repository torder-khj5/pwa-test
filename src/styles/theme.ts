...
//   const keys = Object.keys(variables) as Array<keyof ThemeVariables>;
...
// export const themedPalette: Record<VariableKey, string> = variableKeys.reduce<ThemedPalette>((acc, current) => {
